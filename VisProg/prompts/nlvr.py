...
def create_prompt(inputs,num_prompts=5,method='all',seed=42,group=0):
    if method=='random':
        random.seed(seed)
    ...
    prompt_examples = f'Think step by step to generate a program to verify whether the statement is True or False. Make sure that everything in the program is in English. Below are some examples: \n\n{prompt_examples}'
